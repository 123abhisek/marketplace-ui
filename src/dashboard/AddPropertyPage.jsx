...
export default function AddPropertyPage() {
  const { user, addProperty, notify } = useAppState()
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Stack spacing={2.5}>
            ...
            <CardContent sx={{ p: 3 }}>
              ...
              <Grid container spacing={2.5}>
                {(propType === 'Flat' || propType === 'Residential') && (
                  <>
                    <Grid item xs={6} sm={4}><FormInput name="floor"    label="Floor"     control={control} /></Grid>
                    <Grid item xs={6} sm={4}><FormInput name="rooms"    label="Rooms"     control={control} /></Grid>
                    <Grid item xs={6} sm={4}><FormInput name="bedrooms" label="Bedrooms"  control={control} /></Grid>
                  </>
                )}
                <Grid item xs={12} sm={6}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
            ...
            >
              {submitting ? 'Submitting...' : 'Post Property Listing'}
            </Button>
          </Box>
        </Stack>
      </form>
