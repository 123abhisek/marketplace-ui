...
const normalizeVehicle = (item, i = 0) => ({
  ...
  category: item?.category || item?.vehicle_type || item?.vehicleType || "",
  vehicle_type: item?.category || item?.vehicle_type || item?.vehicleType || "",
  vehicle_number: item?.vehicle_number || item?.vehicleNumber || "",
  brand: item?.brand || "",
  model: item?.model || "",
  year: item?.year || "",
  rto_code: item?.rto_code || item?.rto_code || "",
