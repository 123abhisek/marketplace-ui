    ...
    <Card sx={{ ...cardSx, height: "100%" }}>
      <CardContent sx={{ p: 2.1 }}>
        <Stack spacing={1.25}>
          ...
          <Box>
            <Typography
              sx={{ fontSize: "0.82rem", color: UI.muted, fontWeight: 700 }}
            >
              {label}
            </Typography>
            {sub ? (
    ...
    <Card sx={{ ...cardSx, height: "100%" }}>
      <CardContent sx={{ p: 2.1 }}>
        <Stack spacing={1.2}>
          ...
          <Typography
            sx={{ fontSize: "0.92rem", fontWeight: 800, color: UI.text }}
          >
            {item.name}
          </Typography>
          <Typography
            sx={{ fontSize: "0.8rem", color: UI.muted, lineHeight: 1.7 }}
          >
            {item.address}
          </Typography>
          <Typography
            sx={{ fontSize: "0.78rem", color: UI.muted, fontWeight: 700 }}
          >
    ...
    <Card sx={{ ...cardSx, height: "100%" }}>
      <CardContent sx={{ p: 2.1 }}>
        <Stack spacing={1.4}>
          ...
          <Box>
            <Typography
              sx={{ fontSize: "0.9rem", fontWeight: 800, color: UI.text }}
            >
              {item.title}
            </Typography>
            <Typography
    ...
    <Card sx={{ ...cardSx, height: "100%" }}>
      <CardContent sx={{ p: 1.7 }}>
        <Stack spacing={1.2}>
          ...
          <Box>
            <Typography
              sx={{ fontSize: "0.88rem", fontWeight: 800, color: UI.text }}
            >
              {item.title}
            </Typography>
            <Typography
          ...
          >
            <Box>
              <Typography
                sx={{ fontSize: "0.92rem", fontWeight: 900, color: UI.text }}
              >
                ₹{item.price}
              </Typography>
              <Typography
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box sx={{ minWidth: 0 }}>
          <Typography
            sx={{ fontSize: "0.86rem", color: UI.text, fontWeight: 800 }}
          >
            {title}
          </Typography>
          <Typography
            sx={{ fontSize: "0.76rem", color: UI.muted, lineHeight: 1.6 }}
          >
            {value}
          </Typography>
        </Box>
...
export default function PremiumDashboard() {
  ...
  const wishlist = [
    ...
    },
    {
      ...
      icon: (
        <DirectionsCarRoundedIcon sx={{ fontSize: 42, color: UI.purple }} />
      ),
    },
    {
                  ...
                  >
                    ...
                    >
                      <Box sx={{ minWidth: 0 }}>
                        ...
                        >
                          Manage your orders, addresses, payments, and
                        ...
                        <Box sx={{ minWidth: 0 }}>
                          ...
                          >
                            ...
                            <Chip
                              ...
                              label={
                                user?.isPremium ? "Gold Member" : "Free Member"
                              }
                              sx={{
                                height: 28,
                                borderRadius: "999px",
                    ...
                    <Stack spacing={2.2}>
                            ...
                            {[
                              ...
                              >
                                <CheckCircleRoundedIcon
                                  sx={{ fontSize: 17, color: UI.success }}
                                />
                                <Typography
                                  sx={{
                                    fontSize: "0.82rem",
                      ...
                      <Card sx={cardSx}>
                        <CardContent sx={{ p: { xs: 2, sm: 2.25 } }}>
                          ...
                          >
                            Cashback, coupons, and wallet balance ready for your
                            next checkout.
                          </Typography>
                      ...
                      <Card sx={cardSx}>
                        <CardContent sx={{ p: { xs: 2, sm: 2.25 } }}>
                          ...
                          <Box sx={{ mt: 1.2 }}>
                            ...
                            <SettingRow
                              icon={
                                <DevicesRoundedIcon sx={{ fontSize: 18 }} />
                              }
                      ...
                      {!user?.isPremium ? (
                        ...
                        >
                          <CardContent sx={{ p: { xs: 2, sm: 2.25 } }}>
                            ...
                            >
                              Post unlimited listings, get better visibility,
                              and connect with buyers faster.
                            </Typography>
                            ...
                            <Stack spacing={1} sx={{ mt: 1.6 }}>
                              {[
                                ...
                                >
                                  <CheckCircleRoundedIcon
                                    sx={{ fontSize: 17, color: UI.primary }}
                                  />
                                  <Typography
                                    sx={{
                                      fontSize: "0.82rem",
