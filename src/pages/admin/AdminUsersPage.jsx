    ...
    <Card sx={{ ...cardSx, height: "100%" }}>
      <CardContent sx={{ p: 2.1 }}>
        <Stack spacing={1}>
          ...
          <Typography
            sx={{ fontSize: "0.85rem", fontWeight: 800, color: UI.text }}
          >
            {title}
          </Typography>
          <Typography
            sx={{ fontSize: "0.76rem", color: UI.muted, lineHeight: 1.55 }}
          >
            {subtitle}
          </Typography>
        </Stack>
...
export default function AdminUsersPage() {
  ...
  const loadUsers = async () => {
    ...
    try {
      ...
      setUsers([]);
      setError(
        err?.response?.detail || err?.message || "Failed to load users.",
      );
    } finally {
      setLoading(false);
    }
            ...
            <CardContent sx={{ p: { xs: 1.6, sm: 2.2 } }}>
              ...
              >
                <Box>
                  ...
                  >
                    Displaying all users with name, email, phone number, and
                    role.
                  </Typography>
                </Box>
              ...
              <Stack spacing={1.5}>
                ...
                {loading ? (
                  ...
                  <Box sx={{ py: 8, textAlign: "center" }}>
                    <Typography
                      sx={{ fontSize: "1rem", color: UI.text, fontWeight: 800 }}
                    >
                      No users found
                    </Typography>
                    <Typography
                      sx={{ mt: 0.6, fontSize: "0.84rem", color: UI.muted }}
                    >
                      Try another search term or check whether the API returned
                      any users.
                    </Typography>
                  </Box>
                ) : (
