...
const VALUES = [
  {
    ...
    gradient:
      "linear-gradient(135deg, rgba(251,207,232,0.6) 0%, rgba(254,240,138,0.4) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, rgba(186,230,253,0.6) 0%, rgba(196,181,253,0.4) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, rgba(187,247,208,0.6) 0%, rgba(254,240,138,0.4) 100%)",
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, rgba(254,215,170,0.6) 0%, rgba(251,207,232,0.4) 100%)",
...
const TESTIMONIALS = [
  {
    quote:
      "Sold my apartment within 2 weeks of listing on EasyDeal. The process was incredibly smooth.",
    name: "Vikram S.",
  ...
  {
    quote:
      "Found my dream car at an unbeatable price. The seller was verified and trustworthy.",
    name: "Ananya R.",
    role: "Vehicle Buyer",
    stars: 5,
  ...
  {
    quote:
      "EasyDeal's premium plan was worth every rupee. I got 5 serious inquiries in the first day.",
    name: "Mohit D.",
    role: "Premium Seller",
    stars: 5,
    ...
    <Box sx={{ bgcolor: "#f8f9fb", overflowX: "hidden" }}>
      ...
      <Box
        sx={{
          ...
          overflow: "hidden",
          background:
            "linear-gradient(160deg, #ffffff 0%, #f0fdf9 40%, #eff6ff 100%)",
        }}
      >
        {[
          {
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          <Grid container spacing={{ xs: 5, md: 8 }} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                EasyDeal connects thousands of buyers and sellers across India
                every day. Whether you&apos;re looking for your dream home, a
                reliable vehicle, or want to sell what you own — we make every
                deal easy, safe, and fast.
              </Typography>
      ...
      <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: "#ffffff" }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 7 }}>
            ...
            >
              From properties to vehicles, EasyDeal is your one-stop marketplace
              for buying and selling in India.
            </Typography>
          </Box>
      ...
      <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: "#f8f9fb" }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 7 }}>
            ...
            >
              Every feature we build starts with a simple question: does this
              make the deal easier for our users?
            </Typography>
          </Box>
      ...
      <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: "#ffffff" }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 7 }}>
            ...
            <SectionHeading sx={{ mb: 1.5 }}>
              Start Dealing in 4 Simple Steps
            </SectionHeading>
            <Typography
              sx={{
                fontSize: "1rem",
            ...
            >
              Getting started on EasyDeal is quick and hassle-free. Here&apos;s
              how it works.
            </Typography>
          </Box>
      ...
      <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: "#f8f9fb" }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 7 }}>
            ...
            >
              A small, passionate team on a mission to make property and vehicle
              dealing effortless for every Indian.
            </Typography>
          </Box>
      ...
      <Box sx={{ py: { xs: 8, md: 12 }, bgcolor: "#ffffff" }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: "center", mb: 7 }}>
            ...
            >
              Thousands of happy customers trust EasyDeal for their most
      ...
      <Box
        sx={{
          py: { xs: 8, md: 12 },
          background:
            "linear-gradient(135deg, #f0fdf9 0%, #eff6ff 50%, #fdf4ff 100%)",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          <Grid container spacing={{ xs: 5, md: 8 }} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                We&apos;ve built a platform that works for both buyers and
                sellers. Fast, transparent, and designed from the ground up for
                the Indian market.
              </Typography>
                ...
                {[
                  ...
                  >
                    <CheckCircleRoundedIcon
                      sx={{ fontSize: 20, color: C.primary, flexShrink: 0 }}
                    />
                    <Typography
                      sx={{
                        fontSize: "0.9rem",
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: "relative", zIndex: 1 }}>
          ...
          >
            {isLoggedIn
              ? "Explore listings, connect with sellers, and make your next deal with confidence."
