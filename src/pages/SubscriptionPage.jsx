...
export default function SubscriptionPage() {
  ...
  const activate = async () => {
    ...
    // Only admin and already-premium users are redirected, sellers can still buy premium
    if (isAdmin) {
  ...
  const buttonText = loading
    ...
    : isPremium
      ...
      : isAdmin
        ...
        : isSeller
          ? `Upgrade to Premium — ${formatRupees(finalPayableAmount)}`
  ...
  return (
    <>
      <Helmet>
        <title>Premium Plans — Unlock Full Access | EasyDeal</title>
        <meta name="description" content="Upgrade to EasyDeal Premium for Rs.299. Get unlimited access to property and vehicle listings, seller contact details, and priority on-ground support." />
        <meta name="keywords" content="EasyDeal premium, buy premium plan, property marketplace subscription, unlock listings India" />
        <meta property="og:title" content="EasyDeal Premium — Unlock Full Marketplace Access" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://easydealworld.com/subscription" />
      </Helmet>
    <Box
      sx={{
        py: { xs: 6, md: 10 },
